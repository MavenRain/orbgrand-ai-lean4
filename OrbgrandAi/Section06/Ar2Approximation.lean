...
/-- Recurrence step at index 36: `phi_1 * ar2 35 + phi_2 * ar2 34`.
    Pattern-match arm `(34 + 2)` reduces definitionally to the RHS. -/
theorem ar2_thirty_six (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 36
      = phi1 * ar2 phi1 phi2 z1 z2 35
        + phi2 * ar2 phi1 phi2 z1 z2 34 := rfl

/-- Recurrence step at index 37: `phi_1 * ar2 36 + phi_2 * ar2 35`.
    Pattern-match arm `(35 + 2)` reduces definitionally to the RHS. -/
theorem ar2_thirty_seven (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 37
      = phi1 * ar2 phi1 phi2 z1 z2 36
        + phi2 * ar2 phi1 phi2 z1 z2 35 := rfl

/-- Recurrence step at index 38: `phi_1 * ar2 37 + phi_2 * ar2 36`.
    Pattern-match arm `(36 + 2)` reduces definitionally to the RHS. -/
theorem ar2_thirty_eight (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 38
      = phi1 * ar2 phi1 phi2 z1 z2 37
        + phi2 * ar2 phi1 phi2 z1 z2 36 := rfl

/-- Recurrence step at index 39: `phi_1 * ar2 38 + phi_2 * ar2 37`.
    Pattern-match arm `(37 + 2)` reduces definitionally to the RHS. -/
theorem ar2_thirty_nine (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 39
      = phi1 * ar2 phi1 phi2 z1 z2 38
        + phi2 * ar2 phi1 phi2 z1 z2 37 := rfl

/-- Recurrence step at index 40: `phi_1 * ar2 39 + phi_2 * ar2 38`.
    Pattern-match arm `(38 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 40
      = phi1 * ar2 phi1 phi2 z1 z2 39
        + phi2 * ar2 phi1 phi2 z1 z2 38 := rfl

/-- Recurrence step at index 41: `phi_1 * ar2 40 + phi_2 * ar2 39`.
    Pattern-match arm `(39 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_one (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 41
      = phi1 * ar2 phi1 phi2 z1 z2 40
        + phi2 * ar2 phi1 phi2 z1 z2 39 := rfl

/-- Recurrence step at index 42: `phi_1 * ar2 41 + phi_2 * ar2 40`.
    Pattern-match arm `(40 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_two (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 42
      = phi1 * ar2 phi1 phi2 z1 z2 41
        + phi2 * ar2 phi1 phi2 z1 z2 40 := rfl

/-- Recurrence step at index 43: `phi_1 * ar2 42 + phi_2 * ar2 41`.
    Pattern-match arm `(41 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_three (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 43
      = phi1 * ar2 phi1 phi2 z1 z2 42
        + phi2 * ar2 phi1 phi2 z1 z2 41 := rfl

/-- Recurrence step at index 44: `phi_1 * ar2 43 + phi_2 * ar2 42`.
    Pattern-match arm `(42 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_four (phi1 phi2 z1 z2 : Complex) :
...
/-- Recurrence step at index 46: `phi_1 * ar2 45 + phi_2 * ar2 44`.
    Pattern-match arm `(44 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_six (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 46
      = phi1 * ar2 phi1 phi2 z1 z2 45
        + phi2 * ar2 phi1 phi2 z1 z2 44 := rfl

/-- Recurrence step at index 47: `phi_1 * ar2 46 + phi_2 * ar2 45`.
    Pattern-match arm `(45 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_seven (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 47
      = phi1 * ar2 phi1 phi2 z1 z2 46
        + phi2 * ar2 phi1 phi2 z1 z2 45 := rfl

/-- Recurrence step at index 48: `phi_1 * ar2 47 + phi_2 * ar2 46`.
    Pattern-match arm `(46 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_eight (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 48
      = phi1 * ar2 phi1 phi2 z1 z2 47
        + phi2 * ar2 phi1 phi2 z1 z2 46 := rfl

/-- Recurrence step at index 49: `phi_1 * ar2 48 + phi_2 * ar2 47`.
    Pattern-match arm `(47 + 2)` reduces definitionally to the RHS. -/
theorem ar2_forty_nine (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 49
      = phi1 * ar2 phi1 phi2 z1 z2 48
        + phi2 * ar2 phi1 phi2 z1 z2 47 := rfl

/-- Recurrence step at index 50: `phi_1 * ar2 49 + phi_2 * ar2 48`.
    Pattern-match arm `(48 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 50
      = phi1 * ar2 phi1 phi2 z1 z2 49
        + phi2 * ar2 phi1 phi2 z1 z2 48 := rfl

/-- Recurrence step at index 51: `phi_1 * ar2 50 + phi_2 * ar2 49`.
    Pattern-match arm `(49 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_one (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 51
      = phi1 * ar2 phi1 phi2 z1 z2 50
        + phi2 * ar2 phi1 phi2 z1 z2 49 := rfl

/-- Recurrence step at index 52: `phi_1 * ar2 51 + phi_2 * ar2 50`.
    Pattern-match arm `(50 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_two (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 52
      = phi1 * ar2 phi1 phi2 z1 z2 51
        + phi2 * ar2 phi1 phi2 z1 z2 50 := rfl

/-- Recurrence step at index 53: `phi_1 * ar2 52 + phi_2 * ar2 51`.
    Pattern-match arm `(51 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_three (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 53
      = phi1 * ar2 phi1 phi2 z1 z2 52
        + phi2 * ar2 phi1 phi2 z1 z2 51 := rfl

/-- Recurrence step at index 54: `phi_1 * ar2 53 + phi_2 * ar2 52`.
    Pattern-match arm `(52 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_four (phi1 phi2 z1 z2 : Complex) :
...
/-- Recurrence step at index 56: `phi_1 * ar2 55 + phi_2 * ar2 54`.
    Pattern-match arm `(54 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_six (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 56
      = phi1 * ar2 phi1 phi2 z1 z2 55
        + phi2 * ar2 phi1 phi2 z1 z2 54 := rfl

/-- Recurrence step at index 57: `phi_1 * ar2 56 + phi_2 * ar2 55`.
    Pattern-match arm `(55 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_seven (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 57
      = phi1 * ar2 phi1 phi2 z1 z2 56
        + phi2 * ar2 phi1 phi2 z1 z2 55 := rfl

/-- Recurrence step at index 58: `phi_1 * ar2 57 + phi_2 * ar2 56`.
    Pattern-match arm `(56 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_eight (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 58
      = phi1 * ar2 phi1 phi2 z1 z2 57
        + phi2 * ar2 phi1 phi2 z1 z2 56 := rfl

/-- Recurrence step at index 59: `phi_1 * ar2 58 + phi_2 * ar2 57`.
    Pattern-match arm `(57 + 2)` reduces definitionally to the RHS. -/
theorem ar2_fifty_nine (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 59
      = phi1 * ar2 phi1 phi2 z1 z2 58
        + phi2 * ar2 phi1 phi2 z1 z2 57 := rfl

/-- Recurrence step at index 60: `phi_1 * ar2 59 + phi_2 * ar2 58`.
    Pattern-match arm `(58 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 60
      = phi1 * ar2 phi1 phi2 z1 z2 59
        + phi2 * ar2 phi1 phi2 z1 z2 58 := rfl

/-- Recurrence step at index 61: `phi_1 * ar2 60 + phi_2 * ar2 59`.
    Pattern-match arm `(59 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_one (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 61
      = phi1 * ar2 phi1 phi2 z1 z2 60
        + phi2 * ar2 phi1 phi2 z1 z2 59 := rfl

/-- Recurrence step at index 62: `phi_1 * ar2 61 + phi_2 * ar2 60`.
    Pattern-match arm `(60 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_two (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 62
      = phi1 * ar2 phi1 phi2 z1 z2 61
        + phi2 * ar2 phi1 phi2 z1 z2 60 := rfl

/-- Recurrence step at index 63: `phi_1 * ar2 62 + phi_2 * ar2 61`.
    Pattern-match arm `(61 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_three (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 63
      = phi1 * ar2 phi1 phi2 z1 z2 62
        + phi2 * ar2 phi1 phi2 z1 z2 61 := rfl

/-- Recurrence step at index 64: `phi_1 * ar2 63 + phi_2 * ar2 62`.
    Pattern-match arm `(62 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_four (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 64
      = phi1 * ar2 phi1 phi2 z1 z2 63
        + phi2 * ar2 phi1 phi2 z1 z2 62 := rfl

/-- Recurrence step at index 65: `phi_1 * ar2 64 + phi_2 * ar2 63`.
    Pattern-match arm `(63 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_five (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 65
      = phi1 * ar2 phi1 phi2 z1 z2 64
        + phi2 * ar2 phi1 phi2 z1 z2 63 := rfl

/-- Recurrence step at index 66: `phi_1 * ar2 65 + phi_2 * ar2 64`.
    Pattern-match arm `(64 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_six (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 66
      = phi1 * ar2 phi1 phi2 z1 z2 65
        + phi2 * ar2 phi1 phi2 z1 z2 64 := rfl

/-- Recurrence step at index 67: `phi_1 * ar2 66 + phi_2 * ar2 65`.
    Pattern-match arm `(65 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_seven (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 67
      = phi1 * ar2 phi1 phi2 z1 z2 66
        + phi2 * ar2 phi1 phi2 z1 z2 65 := rfl

/-- Recurrence step at index 68: `phi_1 * ar2 67 + phi_2 * ar2 66`.
    Pattern-match arm `(66 + 2)` reduces definitionally to the RHS. -/
theorem ar2_sixty_eight (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 68
      = phi1 * ar2 phi1 phi2 z1 z2 67
        + phi2 * ar2 phi1 phi2 z1 z2 66 := rfl
...
/-- *Geometric boundary at index 4.*  Specialises
    `ar2_phi2_zero_succ` at `n = 2`: when `phi_2 = 0`, the value at
    index 4 collapses to `phi_1 * (phi_1 * (phi_1 * z_2))`. -/
theorem ar2_phi2_zero_four (phi1 z1 z2 : Complex) :
...
/-- *Lag-skip boundary at index 4.*  Specialises
    `ar2_phi1_zero_succ` at `n = 2`: when `phi_1 = 0`, the value at
    index 4 collapses to `phi_2 * (phi_2 * z_1)` by chaining the
    lag-skip recurrence with `ar2_phi1_zero_two`. -/
theorem ar2_phi1_zero_four (phi2 z1 z2 : Complex) :
...
/-- *Fibonacci-shape boundary at index 4.*  Specialises
    `ar2_phi1_one_phi2_one_succ` at `n = 2`: the value at index 4 is
    `ar2 1 1 z1 z2 3 + ar2 1 1 z1 z2 2`. -/
theorem ar2_phi1_one_phi2_one_four (z1 z2 : Complex) :
    ar2 1 1 z1 z2 4 = ar2 1 1 z1 z2 3 + ar2 1 1 z1 z2 2 :=
  ar2_phi1_one_phi2_one_succ z1 z2 2
...
/-- Recurrence step at index 70: `phi_1 * ar2 69 + phi_2 * ar2 68`.
    Pattern-match arm `(68 + 2)` reduces definitionally to the RHS. -/
theorem ar2_seventy (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 70
      = phi1 * ar2 phi1 phi2 z1 z2 69
        + phi2 * ar2 phi1 phi2 z1 z2 68 := rfl

/-- Recurrence step at index 71: `phi_1 * ar2 70 + phi_2 * ar2 69`.
    Pattern-match arm `(69 + 2)` reduces definitionally to the RHS. -/
theorem ar2_seventy_one (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 71
      = phi1 * ar2 phi1 phi2 z1 z2 70
        + phi2 * ar2 phi1 phi2 z1 z2 69 := rfl

/-- Recurrence step at index 72: `phi_1 * ar2 71 + phi_2 * ar2 70`.
    Pattern-match arm `(70 + 2)` reduces definitionally to the RHS. -/
theorem ar2_seventy_two (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 72
      = phi1 * ar2 phi1 phi2 z1 z2 71
        + phi2 * ar2 phi1 phi2 z1 z2 70 := rfl

/-- Recurrence step at index 73: `phi_1 * ar2 72 + phi_2 * ar2 71`.
    Pattern-match arm `(71 + 2)` reduces definitionally to the RHS. -/
theorem ar2_seventy_three (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 73
      = phi1 * ar2 phi1 phi2 z1 z2 72
        + phi2 * ar2 phi1 phi2 z1 z2 71 := rfl

/-- Recurrence step at index 74: `phi_1 * ar2 73 + phi_2 * ar2 72`.
    Pattern-match arm `(72 + 2)` reduces definitionally to the RHS. -/
theorem ar2_seventy_four (phi1 phi2 z1 z2 : Complex) :
    ar2 phi1 phi2 z1 z2 74
      = phi1 * ar2 phi1 phi2 z1 z2 73
        + phi2 * ar2 phi1 phi2 z1 z2 72 := rfl


/-- Recurrence step at index 75: `phi_1 * ar2 74 + phi_2 * ar2 73`.
    Pattern-match arm `(73 + 2)` reduces definitionally to the RHS. -/
theorem ar2_seventy_five (phi1 phi2 z1 z2 : Complex) :
