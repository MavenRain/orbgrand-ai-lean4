...
/-- *Thirty-fifth sub-diagonal of `delayTapMatrix`.*  Same pattern at
    delay 35. -/
theorem delayTapMatrix_thirty_fifth_subdiag
    {n_s : Nat} {p : Nat} (paths : Fin p -> DelayTapPath)
...
/-- *Thirty-sixth sub-diagonal of `delayTapMatrix`.*  Same pattern at
    delay 36. -/
theorem delayTapMatrix_thirty_sixth_subdiag
    {n_s : Nat} {p : Nat} (paths : Fin p -> DelayTapPath)
...
/-- *Thirty-eighth sub-diagonal of `delayTapMatrix`.*  Same pattern at
    delay 38. -/
theorem delayTapMatrix_thirty_eighth_subdiag
    {n_s : Nat} {p : Nat} (paths : Fin p -> DelayTapPath)
...
/-- *Thirty-ninth sub-diagonal of `delayTapMatrix`.*  Same pattern at
    delay 39. -/
theorem delayTapMatrix_thirty_ninth_subdiag
    {n_s : Nat} {p : Nat} (paths : Fin p -> DelayTapPath)
...
/-- *Fortieth sub-diagonal of `delayTapMatrix`.*  Same pattern at
    delay 40. -/
theorem delayTapMatrix_fortieth_subdiag
    {n_s : Nat} {p : Nat} (paths : Fin p -> DelayTapPath)
...
/-- *Forty-first sub-diagonal of `delayTapMatrix`.*  Same pattern at
    delay 41. -/
theorem delayTapMatrix_forty_first_subdiag
    {n_s : Nat} {p : Nat} (paths : Fin p -> DelayTapPath)
