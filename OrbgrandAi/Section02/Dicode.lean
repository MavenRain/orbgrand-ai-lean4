...
/-- *Dicode bandwidth widens to `27`.*  Chain `dicode_bandwidth_twenty_six`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_twenty_seven
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 27 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_twenty_six sigma rho)

/-- *Dicode bandwidth widens to `28`.*  Chain `dicode_bandwidth_twenty_seven`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_twenty_eight
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 28 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_twenty_seven sigma rho)

/-- *Dicode bandwidth widens to `29`.*  Chain `dicode_bandwidth_twenty_eight`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_twenty_nine
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 29 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_twenty_eight sigma rho)

/-- *Dicode bandwidth widens to `30`.*  Chain `dicode_bandwidth_twenty_nine`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 30 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_twenty_nine sigma rho)
...
/-- *Dicode bandwidth widens to `31`.*  Chain `dicode_bandwidth_thirty`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_one
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 31 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_thirty sigma rho)

/-- *Dicode bandwidth widens to `32`.*  Chain `dicode_bandwidth_thirty_one`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_two
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
...
/-- *Dicode bandwidth widens to `34`.*  Chain `dicode_bandwidth_thirty_three`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_four
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 34 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_thirty_three sigma rho)

/-- *Dicode bandwidth widens to `35`.*  Chain `dicode_bandwidth_thirty_four`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_five
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 35 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_thirty_four sigma rho)

/-- *Dicode bandwidth widens to `36`.*  Chain `dicode_bandwidth_thirty_five`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_six
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 36 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_thirty_five sigma rho)


/-- *Dicode bandwidth widens to `37`.*  Chain `dicode_bandwidth_thirty_six`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_seven
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 37 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_thirty_six sigma rho)

/-- *Dicode bandwidth widens to `38`.*  Chain `dicode_bandwidth_thirty_seven`
    with `LinearIsi.bandwidth_succ`. -/
theorem dicode_bandwidth_thirty_eight
    {n_s : Nat} (sigma : NoisePower) (rho : CorrelationCoefficient) :
    (dicode n_s sigma rho).bandwidth 38 :=
  LinearIsi.bandwidth_succ (dicode_bandwidth_thirty_seven sigma rho)
