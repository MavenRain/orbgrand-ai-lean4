...
/-- *RFView bandwidth widens to `26`.*  Chain `rfView_bandwidth_twenty_five`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_twenty_six
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
...
/-- *RFView bandwidth widens to `28`.*  Chain `rfView_bandwidth_twenty_seven`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_twenty_eight
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 28 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_twenty_seven rowTaps sigma)

/-- *RFView bandwidth widens to `29`.*  Chain `rfView_bandwidth_twenty_eight`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_twenty_nine
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 29 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_twenty_eight rowTaps sigma)

/-- *RFView bandwidth widens to `30`.*  Chain `rfView_bandwidth_twenty_nine`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 30 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_twenty_nine rowTaps sigma)

/-- *RFView bandwidth widens to `31`.*  Chain `rfView_bandwidth_thirty`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_one
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 31 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty rowTaps sigma)

/-- *RFView bandwidth widens to `32`.*  Chain `rfView_bandwidth_thirty_one`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_two
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 32 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_one rowTaps sigma)

/-- *RFView bandwidth widens to `33`.*  Chain `rfView_bandwidth_thirty_two`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_three
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 33 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_two rowTaps sigma)

/-- *RFView bandwidth widens to `34`.*  Chain `rfView_bandwidth_thirty_three`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_four
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 34 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_three rowTaps sigma)

/-- *RFView bandwidth widens to `35`.*  Chain `rfView_bandwidth_thirty_four`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_five
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 35 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_four rowTaps sigma)

/-- *RFView bandwidth widens to `36`.*  Chain `rfView_bandwidth_thirty_five`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_six
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 36 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_five rowTaps sigma)

/-- *RFView bandwidth widens to `37`.*  Chain `rfView_bandwidth_thirty_six`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_seven
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 37 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_six rowTaps sigma)

/-- *RFView bandwidth widens to `38`.*  Chain `rfView_bandwidth_thirty_seven`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_thirty_eight
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 38 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_thirty_seven rowTaps sigma)
...
/-- *RFView bandwidth widens to `40`.*  Chain `rfView_bandwidth_thirty_nine`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_forty
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
...
/-- *RFView bandwidth widens to `42`.*  Chain `rfView_bandwidth_forty_one`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_forty_two
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 42 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_forty_one rowTaps sigma)

/-- *RFView bandwidth widens to `43`.*  Chain `rfView_bandwidth_forty_two`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_forty_three
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 43 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_forty_two rowTaps sigma)

/-- *RFView bandwidth widens to `44`.*  Chain `rfView_bandwidth_forty_three`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_forty_four
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 44 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_forty_three rowTaps sigma)


/-- *RFView bandwidth widens to `45`.*  Chain `rfView_bandwidth_forty_four`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_forty_five
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 45 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_forty_four rowTaps sigma)

/-- *RFView bandwidth widens to `46`.*  Chain `rfView_bandwidth_forty_five`
    with `LinearIsi.bandwidth_succ`. -/
theorem rfView_bandwidth_forty_six
    {n_s : Nat} (rowTaps : Fin n_s -> RFViewTaps) (sigma : NoisePower) :
    (rfView n_s rowTaps sigma).bandwidth 46 :=
  LinearIsi.bandwidth_succ (rfView_bandwidth_forty_five rowTaps sigma)
