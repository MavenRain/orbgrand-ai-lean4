...
/-- *Zero-sigma five above the paper's minimum supported size.*  The closed
    form `cov2DetFormula` is stated valid for `n_s >= 4`; at
    `n_s = 9` with zero noise power it vanishes.  Instantiates
    `cov2DetFormula_zero_sigma` at `n_s = 9`. -/
theorem cov2DetFormula_zero_sigma_nine
    (rho1 rho2 : CorrelationCoefficient) :
    cov2DetFormula ⟨0, le_refl 0⟩ rho1 rho2 9 = 0 :=
  cov2DetFormula_zero_sigma rho1 rho2 (Nat.succ_pos 8)

/-- *Zero-sigma six above the paper's minimum supported size.*  The closed
    form `cov2DetFormula` is stated valid for `n_s >= 4`; at
    `n_s = 10` with zero noise power it vanishes.  Instantiates
    `cov2DetFormula_zero_sigma` at `n_s = 10`. -/
theorem cov2DetFormula_zero_sigma_ten
    (rho1 rho2 : CorrelationCoefficient) :
    cov2DetFormula ⟨0, le_refl 0⟩ rho1 rho2 10 = 0 :=
  cov2DetFormula_zero_sigma rho1 rho2 (Nat.succ_pos 9)


/-- *Zero-sigma seven above the paper's minimum supported size.*  The closed
    form `cov2DetFormula` is stated valid for `n_s >= 4`; at
    `n_s = 11` with zero noise power it vanishes.  Instantiates
    `cov2DetFormula_zero_sigma` at `n_s = 11`. -/
theorem cov2DetFormula_zero_sigma_eleven
    (rho1 rho2 : CorrelationCoefficient) :
    cov2DetFormula ⟨0, le_refl 0⟩ rho1 rho2 11 = 0 :=
  cov2DetFormula_zero_sigma rho1 rho2 (Nat.succ_pos 10)

/-- *Zero-sigma eight above the paper's minimum supported size.*  The closed
    form `cov2DetFormula` is stated valid for `n_s >= 4`; at
    `n_s = 12` with zero noise power it vanishes.  Instantiates
    `cov2DetFormula_zero_sigma` at `n_s = 12`. -/
theorem cov2DetFormula_zero_sigma_twelve
    (rho1 rho2 : CorrelationCoefficient) :
    cov2DetFormula ⟨0, le_refl 0⟩ rho1 rho2 12 = 0 :=
  cov2DetFormula_zero_sigma rho1 rho2 (Nat.succ_pos 11)
