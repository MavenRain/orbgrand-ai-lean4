...
/-- *Boundary case `n_s = 19` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`18` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 19`; reduces by Nat computation. -/
theorem entropyRate2_at_nineteen_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((19 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 17
                  ...
                  / (rho1.val ^ 2 - 1) ^ 16) :=
  entropyRate2_eq sigma rho1 rho2 19

/-- *Boundary case `n_s = 20` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`19` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 20`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((20 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 18
                  ...
                  / (rho1.val ^ 2 - 1) ^ 17) :=
  entropyRate2_eq sigma rho1 rho2 20

/-- *Boundary case `n_s = 21` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`20` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 21`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_one_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((21 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 19
                  ...
                  / (rho1.val ^ 2 - 1) ^ 18) :=
  entropyRate2_eq sigma rho1 rho2 21

/-- *Boundary case `n_s = 22` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`21` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 22`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_two_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((22 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 20
                  ...
                  / (rho1.val ^ 2 - 1) ^ 19) :=
  entropyRate2_eq sigma rho1 rho2 22

/-- *Boundary case `n_s = 23` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`22` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 23`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_three_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((23 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 21
                  ...
                  / (rho1.val ^ 2 - 1) ^ 20) :=
  entropyRate2_eq sigma rho1 rho2 23
...
/-- *Boundary case `n_s = 25` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`24` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 25`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_five_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((25 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 23
                  ...
                  / (rho1.val ^ 2 - 1) ^ 22) :=
  entropyRate2_eq sigma rho1 rho2 25

/-- *Boundary case `n_s = 26` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`25` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 26`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_six_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((26 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 24
                  ...
                  / (rho1.val ^ 2 - 1) ^ 23) :=
  entropyRate2_eq sigma rho1 rho2 26

/-- *Boundary case `n_s = 27` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`26` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 27`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_seven_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
...
/-- *Boundary case `n_s = 29` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`28` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 29`; reduces by Nat computation. -/
theorem entropyRate2_at_twenty_nine_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((29 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 27
                  ...
                  / (rho1.val ^ 2 - 1) ^ 26) :=
  entropyRate2_eq sigma rho1 rho2 29


/-- *Boundary case `n_s = 30` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`29` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 30`; reduces by Nat computation. -/
theorem entropyRate2_at_thirty_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((30 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 28
                  ...
                  / (rho1.val ^ 2 - 1) ^ 27) :=
  entropyRate2_eq sigma rho1 rho2 30

/-- *Boundary case `n_s = 31` of `entropyRate2`.*  Companion of the
    `n_s = 4`-`30` variants.  Specialisation of `entropyRate2_eq` at
    `n_s = 31`; reduces by Nat computation. -/
theorem entropyRate2_at_thirty_one_eq_log_form
    (sigma : NoisePower) (rho1 rho2 : CorrelationCoefficient) :
        ...
        + (1 / (2 * ((31 : Nat) : Real)))
            * Real.log
                (- (rho2.val - 1) ^ 29
                  ...
                  / (rho1.val ^ 2 - 1) ^ 28) :=
  entropyRate2_eq sigma rho1 rho2 31
