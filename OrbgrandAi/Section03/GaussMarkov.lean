...
/-- `cov1_lag` at lag `-17` is `sigma * rho^17`.  Compose
    `cov1_lag_neg` at `i = 17` with `cov1_lag_seventeen`. -/
theorem cov1_lag_neg_seventeen
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho (-17) = sigma.val * rho.val ^ 17 :=
  (cov1_lag_neg sigma rho 17).trans (cov1_lag_seventeen sigma rho)

/-- `cov1_lag` at lag 18 is `sigma * rho^18`.  Same defeq pattern. -/
theorem cov1_lag_eighteen
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
...
/-- `cov1_lag` at lag 19 is `sigma * rho^19`.  Same defeq pattern. -/
theorem cov1_lag_nineteen
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 19 = sigma.val * rho.val ^ 19 := rfl

/-- `cov1_lag` at lag `-19` is `sigma * rho^19`.  Compose
    `cov1_lag_neg` at `i = 19` with `cov1_lag_nineteen`. -/
theorem cov1_lag_neg_nineteen
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho (-19) = sigma.val * rho.val ^ 19 :=
  (cov1_lag_neg sigma rho 19).trans (cov1_lag_nineteen sigma rho)

/-- `cov1_lag` at lag 20 is `sigma * rho^20`.  Same defeq pattern. -/
theorem cov1_lag_twenty
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 20 = sigma.val * rho.val ^ 20 := rfl

/-- `cov1_lag` at lag `-20` is `sigma * rho^20`.  Compose
    `cov1_lag_neg` at `i = 20` with `cov1_lag_twenty`. -/
theorem cov1_lag_neg_twenty
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
...
/-- `cov1_lag` at lag `-21` is `sigma * rho^21`.  Compose
    `cov1_lag_neg` at `i = 21` with `cov1_lag_twenty_one`. -/
theorem cov1_lag_neg_twenty_one
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho (-21) = sigma.val * rho.val ^ 21 :=
  (cov1_lag_neg sigma rho 21).trans (cov1_lag_twenty_one sigma rho)

/-- `cov1_lag` at lag 22 is `sigma * rho^22`.  Same defeq pattern. -/
theorem cov1_lag_twenty_two
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
...
/-- `cov1_lag` at lag 23 is `sigma * rho^23`.  Same defeq pattern. -/
theorem cov1_lag_twenty_three
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 23 = sigma.val * rho.val ^ 23 := rfl

/-- `cov1_lag` at lag `-23` is `sigma * rho^23`.  Compose
    `cov1_lag_neg` at `i = 23` with `cov1_lag_twenty_three`. -/
theorem cov1_lag_neg_twenty_three
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho (-23) = sigma.val * rho.val ^ 23 :=
  (cov1_lag_neg sigma rho 23).trans (cov1_lag_twenty_three sigma rho)

/-- `cov1_lag` at lag 24 is `sigma * rho^24`.  Same defeq pattern. -/
theorem cov1_lag_twenty_four
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 24 = sigma.val * rho.val ^ 24 := rfl

/-- `cov1_lag` at lag 25 is `sigma * rho^25`.  Same defeq pattern. -/
theorem cov1_lag_twenty_five
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 25 = sigma.val * rho.val ^ 25 := rfl
...
/-- `cov1_lag` at lag `-25` is `sigma * rho^25`.  Compose
    `cov1_lag_neg` at `i = 25` with `cov1_lag_twenty_five`. -/
theorem cov1_lag_neg_twenty_five
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho (-25) = sigma.val * rho.val ^ 25 :=
  (cov1_lag_neg sigma rho 25).trans (cov1_lag_twenty_five sigma rho)

/-- `cov1_lag` at lag 26 is `sigma * rho^26`.  Same defeq pattern. -/
theorem cov1_lag_twenty_six
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 26 = sigma.val * rho.val ^ 26 := rfl

/-- `cov1_lag` at lag `-26` is `sigma * rho^26`.  Compose
    `cov1_lag_neg` at `i = 26` with `cov1_lag_twenty_six`. -/
theorem cov1_lag_neg_twenty_six
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho (-26) = sigma.val * rho.val ^ 26 :=
  (cov1_lag_neg sigma rho 26).trans (cov1_lag_twenty_six sigma rho)

/-- `cov1_lag` at lag 27 is `sigma * rho^27`.  Same defeq pattern. -/
theorem cov1_lag_twenty_seven
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
    cov1_lag sigma rho 27 = sigma.val * rho.val ^ 27 := rfl


/-- `cov1_lag` at lag `-27` is `sigma * rho^27`.  Compose
    `cov1_lag_neg` at `i = 27` with `cov1_lag_twenty_seven`. -/
theorem cov1_lag_neg_twenty_seven
    (sigma : NoisePower) (rho : CorrelationCoefficient) :
