...
/-- *Pointwise negation of zero.*  `(-(0 : Codeword n)) i = (0 : Codeword n) i`.
    One-liner via `congrFun` on `Codeword.neg_zero`, mirroring how
    `Codeword.neg_eq_self_apply` unfolds `Codeword.neg_eq_self`. -/
theorem Codeword.neg_zero_apply {n : Nat} (i : Fin n) :
    (-(0 : Codeword n)) i = (0 : Codeword n) i :=
  congrFun (Codeword.neg_zero) i
...
/-- *Pointwise double negation.*  `(-(-a)) i = a i`.  One-liner via
    `congrFun` on `Codeword.neg_neg`, mirroring how
    `Codeword.neg_zero_apply` unfolds `Codeword.neg_zero` and
    `Codeword.neg_eq_self_apply` unfolds `Codeword.neg_eq_self`. -/
theorem Codeword.neg_neg_apply {n : Nat} (a : Codeword n) (i : Fin n) :
    (-(-a)) i = a i :=
...
/-- *Pointwise triple negation.*  `(-(-(-a))) i = (-a) i`.  One-liner via
    `congrFun` on `Codeword.neg_neg_neg`, mirroring how
    `Codeword.neg_neg_apply` unfolds `Codeword.neg_neg` and
    `Codeword.neg_zero_apply` unfolds `Codeword.neg_zero`. -/
theorem Codeword.neg_neg_neg_apply {n : Nat} (a : Codeword n) (i : Fin n) :
    (-(-(-a))) i = (-a) i :=
