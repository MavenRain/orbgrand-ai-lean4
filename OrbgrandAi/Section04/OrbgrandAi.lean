...
/-- *Vacuous codebook at budget `3`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 3`. -/
theorem orbgrandAi_empty_codebook_mk_three
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 3) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 3) patterns

/-- *Vacuous codebook on the empty pattern list at budget `3`.*
    Specialises `orbgrandAi_empty_codebook_mk_three` at
    `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_three
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 3)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_three Y []

/-- *Vacuous codebook at budget `4`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 4`. -/
theorem orbgrandAi_empty_codebook_mk_four
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 4) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 4) patterns

/-- *Vacuous codebook on the empty pattern list at budget `4`.*
    Specialises `orbgrandAi_empty_codebook_mk_four` at
    `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_four
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 4)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_four Y []

/-- *Vacuous codebook at budget `5`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 5`. -/
theorem orbgrandAi_empty_codebook_mk_five
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 5) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 5) patterns

/-- *Vacuous codebook on the empty pattern list at budget `5`.*
    Specialises `orbgrandAi_empty_codebook_mk_five` at
    `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_five
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 5)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_five Y []

/-- *Vacuous codebook at budget `6`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 6`. -/
theorem orbgrandAi_empty_codebook_mk_six
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 6) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 6) patterns

/-- *Vacuous codebook on the empty pattern list at budget `6`.*
    Specialises `orbgrandAi_empty_codebook_mk_six` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_six
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 6)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_six Y []

/-- *Vacuous codebook at budget `7`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 7`. -/
theorem orbgrandAi_empty_codebook_mk_seven
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 7) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 7) patterns

/-- *Vacuous codebook on the empty pattern list at budget `7`.*
    Specialises `orbgrandAi_empty_codebook_mk_seven` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_seven
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 7)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_seven Y []

/-- *Vacuous codebook at budget `8`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 8`. -/
theorem orbgrandAi_empty_codebook_mk_eight
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 8) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 8) patterns

/-- *Vacuous codebook on the empty pattern list at budget `8`.*
    Specialises `orbgrandAi_empty_codebook_mk_eight` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_eight
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 8)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_eight Y []

/-- *Vacuous codebook at budget `9`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 9`. -/
theorem orbgrandAi_empty_codebook_mk_nine
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 9) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 9) patterns

/-- *Vacuous codebook on the empty pattern list at budget `9`.*
    Specialises `orbgrandAi_empty_codebook_mk_nine` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_nine
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 9)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_nine Y []

/-- *Vacuous codebook at budget `10`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 10`. -/
theorem orbgrandAi_empty_codebook_mk_ten
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 10) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 10) patterns

/-- *Vacuous codebook on the empty pattern list at budget `10`.*
    Specialises `orbgrandAi_empty_codebook_mk_ten` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_ten
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 10)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_ten Y []

/-- *Vacuous codebook at budget `11`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 11`. -/
theorem orbgrandAi_empty_codebook_mk_eleven
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 11) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 11) patterns

/-- *Vacuous codebook on the empty pattern list at budget `11`.*
    Specialises `orbgrandAi_empty_codebook_mk_eleven` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_eleven
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 11)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_eleven Y []
...
/-- *Vacuous codebook on the empty pattern list at unit budget.*
    Specialises `orbgrandAi_empty_codebook_mk_one` at
    `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_one
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 1)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_one Y []

/-- *Vacuous codebook on the empty pattern list at budget `2`.*
    Specialises `orbgrandAi_empty_codebook_mk_two` at
    `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_two
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 2)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_two Y []
...
/-- *Vacuous codebook at budget `13`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 13`. -/
theorem orbgrandAi_empty_codebook_mk_thirteen
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 13) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 13) patterns

/-- *Vacuous codebook on the empty pattern list at budget `13`.*
    Specialises `orbgrandAi_empty_codebook_mk_thirteen` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_thirteen
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 13)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_thirteen Y []

/-- *Vacuous codebook at budget `14`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 14`. -/
theorem orbgrandAi_empty_codebook_mk_fourteen
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 14) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 14) patterns

/-- *Vacuous codebook on the empty pattern list at budget `14`.*
    Specialises `orbgrandAi_empty_codebook_mk_fourteen` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_fourteen
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 14)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_fourteen Y []


/-- *Vacuous codebook at budget `15`.*  Specialises
    `orbgrandAi_empty_codebook` at `AbandonmentBudget.mk 15`. -/
theorem orbgrandAi_empty_codebook_mk_fifteen
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s)
    (patterns : List (Fin (n_s / b) -> Fin numCandidates)) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 15) patterns = none :=
  orbgrandAi_empty_codebook Y (AbandonmentBudget.mk 15) patterns

/-- *Vacuous codebook on the empty pattern list at budget `15`.*
    Specialises `orbgrandAi_empty_codebook_mk_fifteen` at `patterns = []`. -/
theorem orbgrandAi_empty_codebook_nil_mk_fifteen
    {n_s b numCandidates : Nat}
    (Y : Codeword n_s) :
    orbgrandAi (b := b) (numCandidates := numCandidates)
      Y (fun _ => false) (AbandonmentBudget.mk 15)
      ([] : List (Fin (n_s / b) -> Fin numCandidates)) = none :=
  orbgrandAi_empty_codebook_mk_fifteen Y []
